	...
	public class Hediff_Pregnant : HediffWithComps
	{
		...
		public override string DebugString
		{
			get
			{
				...
				stringBuilder.AppendLine("Time left: " + ((int)((1f - this.GestationProgress) * this.pawn.RaceProps.gestationPeriodDays * 60000f)).TicksToPeriodString(true));
		...
		public static void DoBirthSpawn(Pawn mother, Pawn father)
		{
			...
			pawnGenerationRequest.kindDef = mother.kindDef;
			pawnGenerationRequest.faction = mother.Faction;
