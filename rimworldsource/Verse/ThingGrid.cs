...
namespace Verse
{
	public sealed class ThingGrid
	{
		...
		{
			ThingGrid.<ThingsAt>c__Iterator15D <ThingsAt>c__Iterator15D = new ThingGrid.<ThingsAt>c__Iterator15D();
			<ThingsAt>c__Iterator15D.c = c;
			<ThingsAt>c__Iterator15D.<$>c = c;
			<ThingsAt>c__Iterator15D.<>f__this = this;
			ThingGrid.<ThingsAt>c__Iterator15D expr_1C = <ThingsAt>c__Iterator15D;
			expr_1C.$PC = -2;
			return expr_1C;
		}
		...
		public bool CellContains(IntVec3 c, ThingCategory eType)
		{
			return this.ThingAt(c, eType) != null;
		}
		public Thing ThingAt(IntVec3 c, ThingCategory eType)
		{
			if (!c.InBounds())
			{
				return null;
