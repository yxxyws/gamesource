...
namespace RimWorld
{
	public class MapCondition_Flashstorm : MapCondition
	{
		...
		public override bool RainAllowed
		{
			get
			{
				return false;
		...
		{
			MapCondition_Flashstorm.<GetPotentiallyAffectedCells>c__IteratorB4 <GetPotentiallyAffectedCells>c__IteratorB = new MapCondition_Flashstorm.<GetPotentiallyAffectedCells>c__IteratorB4();
			<GetPotentiallyAffectedCells>c__IteratorB.center = center;
			<GetPotentiallyAffectedCells>c__IteratorB.<$>center = center;
			<GetPotentiallyAffectedCells>c__IteratorB.<>f__this = this;
			MapCondition_Flashstorm.<GetPotentiallyAffectedCells>c__IteratorB4 expr_1C = <GetPotentiallyAffectedCells>c__IteratorB;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
