...
namespace RimWorld
{
	public abstract class IncidentWorker_PsychicEmanation : IncidentWorker
	{
		...
		{
			return !Find.MapConditionManager.ConditionIsActive(MapConditionDefOf.PsychicDrone) && !Find.MapConditionManager.ConditionIsActive(MapConditionDefOf.PsychicSoothe) && Find.ListerThings.ThingsOfDef(ThingDefOf.CrashedPsychicEmanatorShipPart).Count <= 0;
		}
