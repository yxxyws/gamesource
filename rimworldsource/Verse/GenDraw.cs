...
namespace Verse
{
	...
	public static class GenDraw
	{
		...
		private static readonly Material InteractionCellMaterial = MaterialPool.MatFrom("UI/Overlays/InteractionCell", ShaderDatabase.Transparent);
		...
		{
			Vector3 position = c.ToVector3ShiftedWithAltitude(AltitudeLayer.Waist);
