...
namespace RimWorld
{
	public class PawnRelationDef : Def
	{
		...
		{
			PawnRelationDef.<ConfigErrors>c__Iterator74 <ConfigErrors>c__Iterator = new PawnRelationDef.<ConfigErrors>c__Iterator74();
			<ConfigErrors>c__Iterator.<>f__this = this;
			PawnRelationDef.<ConfigErrors>c__Iterator74 expr_0E = <ConfigErrors>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
