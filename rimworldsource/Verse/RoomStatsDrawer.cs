...
namespace Verse
{
	internal static class RoomStatsDrawer
	{
		...
		{
			RoomStatsDrawer.<RoomStatsOnGUI>c__AnonStorey3BF <RoomStatsOnGUI>c__AnonStorey3BF = new RoomStatsDrawer.<RoomStatsOnGUI>c__AnonStorey3BF();
			if (!RoomStatsDrawer.ShouldShowRoomStats)
			{
				return;
			}
			<RoomStatsOnGUI>c__AnonStorey3BF.room = Gen.MouseCell().GetRoom();
			Text.Font = GameFont.Small;
			RoomStatsDrawer.CalculateColumnsSizes(<RoomStatsOnGUI>c__AnonStorey3BF.room);
			<RoomStatsOnGUI>c__AnonStorey3BF.windowRect = new Rect(Event.current.mousePosition.x, Event.current.mousePosition.y, 108f + RoomStatsDrawer.statLabelColumnWidth + RoomStatsDrawer.scoreColumnWidth + RoomStatsDrawer.scoreStageLabelColumnWidth, (float)(65 + RoomStatsDrawer.DisplayedRoomStatsCount * 25));
			RoomStatsDrawer.<RoomStatsOnGUI>c__AnonStorey3BF expr_8A_cp_0 = <RoomStatsOnGUI>c__AnonStorey3BF;
			expr_8A_cp_0.windowRect.x = expr_8A_cp_0.windowRect.x + 5f;
			RoomStatsDrawer.<RoomStatsOnGUI>c__AnonStorey3BF expr_A1_cp_0 = <RoomStatsOnGUI>c__AnonStorey3BF;
			expr_A1_cp_0.windowRect.y = expr_A1_cp_0.windowRect.y + 5f;
			if (<RoomStatsOnGUI>c__AnonStorey3BF.windowRect.xMax > (float)Screen.width)
			{
				RoomStatsDrawer.<RoomStatsOnGUI>c__AnonStorey3BF expr_CE_cp_0 = <RoomStatsOnGUI>c__AnonStorey3BF;
				expr_CE_cp_0.windowRect.x = expr_CE_cp_0.windowRect.x - (<RoomStatsOnGUI>c__AnonStorey3BF.windowRect.width + 10f);
			}
			if (<RoomStatsOnGUI>c__AnonStorey3BF.windowRect.yMax > (float)Screen.height)
			{
				RoomStatsDrawer.<RoomStatsOnGUI>c__AnonStorey3BF expr_107_cp_0 = <RoomStatsOnGUI>c__AnonStorey3BF;
				expr_107_cp_0.windowRect.y = expr_107_cp_0.windowRect.y - (<RoomStatsOnGUI>c__AnonStorey3BF.windowRect.height + 10f);
			}
			Find.WindowStack.ImmediateWindow(74975, <RoomStatsOnGUI>c__AnonStorey3BF.windowRect, WindowLayer.Super, delegate
			{
				ConceptDatabase.KnowledgeDemonstrated(ConceptDefOf.InspectRoomStats, KnowledgeAmount.GuiFrame);
				Text.Font = GameFont.Small;
				float num = 19f;
				Rect rect = new Rect(19f, num, <RoomStatsOnGUI>c__AnonStorey3BF.windowRect.width - 38f, 100f);
				GUI.color = Color.white;
				Widgets.Label(rect, RoomStatsDrawer.GetRoomRoleLabel(<RoomStatsOnGUI>c__AnonStorey3BF.room));
				num += 25f;
				for (int i = 0; i < DefDatabase<RoomStatDef>.AllDefsListForReading.Count; i++)
				{
					...
					{
						float stat = <RoomStatsOnGUI>c__AnonStorey3BF.room.GetStat(roomStatDef);
						RoomStatScoreStage scoreStage = roomStatDef.GetScoreStage(stat);
						if (<RoomStatsOnGUI>c__AnonStorey3BF.room.Role.IsStatRelated(roomStatDef))
						{
