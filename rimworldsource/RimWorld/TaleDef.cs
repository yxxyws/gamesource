...
namespace RimWorld
{
	public class TaleDef : Def
	{
		...
		{
			TaleDef.<ConfigErrors>c__Iterator76 <ConfigErrors>c__Iterator = new TaleDef.<ConfigErrors>c__Iterator76();
			<ConfigErrors>c__Iterator.<>f__this = this;
			TaleDef.<ConfigErrors>c__Iterator76 expr_0E = <ConfigErrors>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
