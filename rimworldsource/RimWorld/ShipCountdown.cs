...
namespace RimWorld
{
	public static class ShipCountdown
	{
		...
		public static void InitiateCountdown(Building launchingShipRoot)
		{
			...
			Find.CameraFade.StartFade(Color.white, 7.2f);
		}
		...
		private static void CountdownEnded()
		{
			...
			Page_Credits page_Credits = new Page_Credits(preCreditsMessage);
			page_Credits.wonGame = true;
			Find.WindowStack.Add(page_Credits);
			Find.MusicManagerMap.ForceSilenceFor(999f);
			Find.CameraFade.StartFade(Color.clear, 3f);
		}
	}
}
