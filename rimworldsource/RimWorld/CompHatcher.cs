...
namespace RimWorld
{
	public class CompHatcher : ThingComp
	{
		...
		public void Hatch()
		{
			...
			pawnGenerationRequest.kindDef = this.Props.hatcherPawn;
			pawnGenerationRequest.faction = this.hatcheeFaction;
			pawnGenerationRequest.newborn = true;
		...
		public override void PreAbsorbStack(Thing otherStack, int count)
		{
			...
			float to = comp.gestateProgress;
			this.gestateProgress = Mathf.Lerp(this.gestateProgress, to, t);
			float to2 = comp.frozenPercentage;
			this.frozenPercentage = Mathf.Lerp(this.frozenPercentage, to2, t);
		}
