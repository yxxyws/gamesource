...
namespace Verse
{
	public class SimpleCurveView
	{
		...
		public IEnumerable<float> DebugInputValues
		{
			get
			{
				SimpleCurveView.<>c__Iterator196 <>c__Iterator = new SimpleCurveView.<>c__Iterator196();
				<>c__Iterator.<>f__this = this;
				SimpleCurveView.<>c__Iterator196 expr_0E = <>c__Iterator;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
