	...
	public class SubSoundDef : Editable
	{
		...
		public ResolvedGrain RandomizedResolvedGrain()
		{
			...
			while (true)
			{
				...
				{
					if (!(
						from g in this.recentlyPlayedResolvedGrains
				...
				{
					if (this.repeatMode != RepeatSelectMode.NeverTwice || !chosenGrain.Equals(this.lastPlayedResolvedGrain))
					{
						break;
					}
				}
		...
		{
			SubSoundDef.<ConfigErrors>c__Iterator149 <ConfigErrors>c__Iterator = new SubSoundDef.<ConfigErrors>c__Iterator149();
			<ConfigErrors>c__Iterator.<>f__this = this;
			SubSoundDef.<ConfigErrors>c__Iterator149 expr_0E = <ConfigErrors>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
