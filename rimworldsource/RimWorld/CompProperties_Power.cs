...
namespace RimWorld
{
	public class CompProperties_Power : CompProperties
	{
		...
		{
			CompProperties_Power.<ConfigErrors>c__Iterator65 <ConfigErrors>c__Iterator = new CompProperties_Power.<ConfigErrors>c__Iterator65();
			<ConfigErrors>c__Iterator.parentDef = parentDef;
			<ConfigErrors>c__Iterator.<$>parentDef = parentDef;
			<ConfigErrors>c__Iterator.<>f__this = this;
			CompProperties_Power.<ConfigErrors>c__Iterator65 expr_1C = <ConfigErrors>c__Iterator;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
