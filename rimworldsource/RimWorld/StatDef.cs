...
namespace RimWorld
{
	public class StatDef : Def
	{
		...
		{
			StatDef.<ConfigErrors>c__Iterator75 <ConfigErrors>c__Iterator = new StatDef.<ConfigErrors>c__Iterator75();
			<ConfigErrors>c__Iterator.<>f__this = this;
			StatDef.<ConfigErrors>c__Iterator75 expr_0E = <ConfigErrors>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
