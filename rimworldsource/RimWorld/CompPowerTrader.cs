		...
		public bool PowerOn
		{
			...
			set
			{
				...
				if (this.powerOnInt)
				{
					...
					SoundDef soundDef = ((CompProperties_Power)this.parent.def.CompDefFor<CompPowerTrader>()).soundPowerOn;
				...
				else
				{
					...
					SoundDef soundDef2 = ((CompProperties_Power)this.parent.def.CompDefFor<CompPowerTrader>()).soundPowerOff;
