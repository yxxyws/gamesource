...
namespace RimWorld
{
	public class LordToil_Siege : LordToil
	{
		...
		private IEnumerable<Frame> Frames
		{
			get
			{
				LordToil_Siege.<>c__Iterator56 <>c__Iterator = new LordToil_Siege.<>c__Iterator56();
				<>c__Iterator.<>f__this = this;
				LordToil_Siege.<>c__Iterator56 expr_0E = <>c__Iterator;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		public override void Init()
		{
			...
			list2.Add(list4);
			DropPodUtility.DropThingGroupsNear(data.siegeCenter, list2, 110, true, false, true);
		...
		public override void UpdateAllDuties()
		{
			...
			else
			{
				...
				int num2 = (
					from b in Find.ListerThings.ThingsInGroup(ThingRequestGroup.BuildingArtificial)
				...
				for (int k = 0; k < num4; k++)
				{
					Pawn pawn2;
					if ((
						from pa in this.lord.ownedPawns
		...
		private void DropSupplies(ThingDef thingDef, int count)
		{
			...
			list.Add(thing);
			DropPodUtility.DropThingsNear(this.Data.siegeCenter, list, 110, true, false, true);
		}
