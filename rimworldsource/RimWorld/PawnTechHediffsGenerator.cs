	...
	public static class PawnTechHediffsGenerator
	{
		public static void GeneratePartsAndImplantsFor(Pawn pawn)
		{
			...
			if (source.Any<ThingDef>())
			{
				...
				IEnumerable<RecipeDef> source2 = 
					from x in DefDatabase<RecipeDef>.AllDefs
				...
				if (source2.Any<RecipeDef>())
				{
					...
					{
						recipeDef.Worker.ApplyOnPawn(pawn, recipeDef.Worker.GetPartsToApplyOn(pawn, recipeDef).RandomElement<BodyPartRecord>(), null);
					}
				}
			}
		}
