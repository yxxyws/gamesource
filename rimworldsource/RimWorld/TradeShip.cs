...
namespace RimWorld
{
	public class TradeShip : PassingShip, ITrader
	{
		...
		public IEnumerable<Thing> ColonyThingsWillingToBuy
		{
			get
			{
				TradeShip.<>c__Iterator102 <>c__Iterator = new TradeShip.<>c__Iterator102();
				TradeShip.<>c__Iterator102 expr_07 = <>c__Iterator;
				expr_07.$PC = -2;
				return expr_07;
			}
		}
		...
		{
			this.def = def;
			this.name = NameGenerator.GenerateName(RulePackDefOf.NamerTraderGeneral, 
		...
		public override void TryOpenComms(Pawn negotiator)
		{
			...
			TradeSession.SetupWith(this, negotiator);
			...
			PawnRelationUtility.Notify_PawnsSeenByPlayer(this.Goods.OfType<Pawn>(), "LetterFamilyMembersTraderShipSlaves", false);
		...
		public void GiveSoldThingToBuyer(Thing toGive, Thing originalThingFromStock)
		{
			...
			this.SpawnDropPod(toGive);
		}
		private void SpawnDropPod(Thing t)
		{
