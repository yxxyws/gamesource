...
namespace Verse.Noise
{
	public static class NoiseDebugUI
	{
		...
		public static void NoiseDebugOnGUI()
		{
			...
			if (Widgets.TextButton(new Rect(100f, 0f, 200f, 30f), "Clear noise renders", true, false))
			{
				NoiseDebugUI.Clear();
			}
			if (Widgets.TextButton(new Rect(300f, 0f, 200f, 30f), "Hide noise renders", true, false))
			{
