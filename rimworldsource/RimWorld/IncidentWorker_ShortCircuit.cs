...
namespace RimWorld
{
	public class IncidentWorker_ShortCircuit : IncidentWorker
	{
		...
		{
			return 
				from Building_Battery bat in Find.ListerBuildings.AllBuildingsColonistOfDef(ThingDefOf.Battery)
		...
		public override bool TryExecute(IncidentParms parms)
		{
			...
			List<CompPower> list = (
				from trans in powerNet.transmitters
			...
			GenExplosion.DoExplosion(parent.Position, num2, DamageDefOf.Flame, null, null, null, null, null, 0f, false, null, 0f);
			if (num2 > 3.5f)
			{
				GenExplosion.DoExplosion(parent.Position, num2 * 0.3f, DamageDefOf.Bomb, null, null, null, null, null, 0f, false, null, 0f);
			}
			if (!parent.Destroyed)
			{
