...
namespace RimWorld
{
	...
	public class PersonalShield : Apparel
	{
		...
		private bool ShouldDisplay
		{
			get
			{
				return !this.wearer.Dead && !this.wearer.Downed && (!this.wearer.IsPrisonerOfColony || (this.wearer.MentalStateDef != null && this.wearer.MentalStateDef.isAggro)) && (this.wearer.Drafted || this.wearer.Faction.HostileTo(Faction.OfColony) || Find.TickManager.TicksGame < this.lastKeepDisplayTick + this.KeepDisplayingTicks);
			}
		}
		...
		{
			PersonalShield.<GetWornGizmos>c__IteratorEB <GetWornGizmos>c__IteratorEB = new PersonalShield.<GetWornGizmos>c__IteratorEB();
			<GetWornGizmos>c__IteratorEB.<>f__this = this;
			PersonalShield.<GetWornGizmos>c__IteratorEB expr_0E = <GetWornGizmos>c__IteratorEB;
			expr_0E.$PC = -2;
			return expr_0E;
		}
