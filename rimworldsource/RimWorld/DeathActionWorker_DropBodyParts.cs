			...
			if (lifeStage.dropBodyPart != null)
			{
				...
				while (true)
				{
					BodyPartRecord bodyPartRecord = (
						from x in innerPawn.health.hediffSet.GetNotMissingParts(null, null)
					...
					GenPlace.TryPlaceThing(thing, corpse.Position, ThingPlaceMode.Near, out forbiddenIfOutsideHomeArea);
