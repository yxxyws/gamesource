...
namespace RimWorld
{
	public class JoyGiverDef : Def
	{
		...
		{
			JoyGiverDef.<ConfigErrors>c__Iterator72 <ConfigErrors>c__Iterator = new JoyGiverDef.<ConfigErrors>c__Iterator72();
			<ConfigErrors>c__Iterator.<>f__this = this;
			JoyGiverDef.<ConfigErrors>c__Iterator72 expr_0E = <ConfigErrors>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
