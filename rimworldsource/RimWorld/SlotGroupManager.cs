...
namespace RimWorld
{
	public sealed class SlotGroupManager
	{
		...
		public IEnumerable<IntVec3> AllSlots
		{
			get
			{
				SlotGroupManager.<>c__IteratorD7 <>c__IteratorD = new SlotGroupManager.<>c__IteratorD7();
				<>c__IteratorD.<>f__this = this;
				SlotGroupManager.<>c__IteratorD7 expr_0E = <>c__IteratorD;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
