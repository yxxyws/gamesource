...
namespace Verse
{
	public static class XmlInheritance
	{
		...
		public static void TryRegisterAllFrom(LoadableXmlAsset xmlAsset, LoadedMod mod)
		{
		...
		public static void TryRegister(XmlNode node, LoadedMod mod)
		{
		...
		private static void ResolveXmlNodes()
		{
			List<XmlInheritance.XmlInheritanceNode> list = (
				from x in XmlInheritance.unresolvedNodes
