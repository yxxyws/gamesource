...
namespace Verse
{
	public abstract class SkyOverlay
	{
		...
		public void DrawOverlay()
		{
			...
			if (this.screenOverlayMat != null)
			{
				float num = Find.CameraMapGameObject.camera.orthographicSize * 2f;
				Vector3 s = new Vector3(num * Find.CameraMapGameObject.camera.aspect, 1f, num);
				Vector3 position2 = Find.CameraMapGameObject.transform.position;
