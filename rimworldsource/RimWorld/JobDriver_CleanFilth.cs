...
namespace RimWorld
{
	public class JobDriver_CleanFilth : JobDriver
	{
		...
		{
			JobDriver_CleanFilth.<MakeNewToils>c__Iterator13 <MakeNewToils>c__Iterator = new JobDriver_CleanFilth.<MakeNewToils>c__Iterator13();
			<MakeNewToils>c__Iterator.<>f__this = this;
			JobDriver_CleanFilth.<MakeNewToils>c__Iterator13 expr_0E = <MakeNewToils>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
