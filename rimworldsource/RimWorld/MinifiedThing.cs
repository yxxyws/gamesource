...
namespace RimWorld
{
	public class MinifiedThing : ThingWithComps
	{
		...
		public override string LabelBase
		{
			get
			{
				return this.innerThing.LabelBase;
			}
		}
		...
		{
			MinifiedThing.<GetGizmos>c__IteratorCC <GetGizmos>c__IteratorCC = new MinifiedThing.<GetGizmos>c__IteratorCC();
			<GetGizmos>c__IteratorCC.<>f__this = this;
			MinifiedThing.<GetGizmos>c__IteratorCC expr_0E = <GetGizmos>c__IteratorCC;
			expr_0E.$PC = -2;
			return expr_0E;
		}
