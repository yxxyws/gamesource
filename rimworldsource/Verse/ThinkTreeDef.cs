...
namespace Verse
{
	public class ThinkTreeDef : Def
	{
		...
		{
			ThinkTreeDef.<ConfigErrors>c__Iterator152 <ConfigErrors>c__Iterator = new ThinkTreeDef.<ConfigErrors>c__Iterator152();
			<ConfigErrors>c__Iterator.<>f__this = this;
			ThinkTreeDef.<ConfigErrors>c__Iterator152 expr_0E = <ConfigErrors>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
