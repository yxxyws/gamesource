...
namespace Verse
{
	public class KeyPrefsData
	{
		...
		{
			KeyPrefsData.<ConflictingBindings>c__Iterator1AE <ConflictingBindings>c__Iterator1AE = new KeyPrefsData.<ConflictingBindings>c__Iterator1AE();
			<ConflictingBindings>c__Iterator1AE.keyDef = keyDef;
			<ConflictingBindings>c__Iterator1AE.code = code;
			<ConflictingBindings>c__Iterator1AE.<$>keyDef = keyDef;
			<ConflictingBindings>c__Iterator1AE.<$>code = code;
			<ConflictingBindings>c__Iterator1AE.<>f__this = this;
			KeyPrefsData.<ConflictingBindings>c__Iterator1AE expr_2A = <ConflictingBindings>c__Iterator1AE;
			expr_2A.$PC = -2;
			return expr_2A;
		}
