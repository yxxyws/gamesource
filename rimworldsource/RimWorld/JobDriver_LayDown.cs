...
namespace RimWorld
{
	public class JobDriver_LayDown : JobDriver
	{
		...
		{
			JobDriver_LayDown.<MakeNewToils>c__Iterator43 <MakeNewToils>c__Iterator = new JobDriver_LayDown.<MakeNewToils>c__Iterator43();
			<MakeNewToils>c__Iterator.<>f__this = this;
			JobDriver_LayDown.<MakeNewToils>c__Iterator43 expr_0E = <MakeNewToils>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
