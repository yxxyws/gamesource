...
namespace Verse.AI
{
	public class Job : IExposable
	{
		...
		public List<TargetInfo> placedTargets;
		...
		public bool stopIfTooFarFromHive;
		public bool eatFromInventory;
		...
		public void ExposeData()
		{
			...
			Scribe_Collections.LookList<TargetInfo>(ref this.placedTargets, "placedTargets", LookMode.Undefined, new object[0]);
			...
			Scribe_Values.LookValue<bool>(ref this.stopIfTooFarFromHive, "stopIfTooFarFromHive", false, false);
			Scribe_Values.LookValue<bool>(ref this.eatFromInventory, "eatFromInventory", false, false);
