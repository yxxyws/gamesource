...
namespace RimWorld
{
	public static class GenPlant
	{
			...
			if (plantDef.passability == Traversability.Impassable)
			{
				for (int j = 0; j < 4; j++)
				{
					...
					if (c2.InBounds())
					{
						...
						if (edifice != null && edifice.def.thingClass == typeof(Building_Door))
						{
							return false;
						}
					}
		...
		public static void WritePlantProportions()
		{
		...
		[DebuggerHidden]
		public static IEnumerable<ThingDef> ValidPlantTypesForGrower(object sel)
		{
			GenPlant.<ValidPlantTypesForGrower>c__Iterator11C <ValidPlantTypesForGrower>c__Iterator11C = new GenPlant.<ValidPlantTypesForGrower>c__Iterator11C();
			<ValidPlantTypesForGrower>c__Iterator11C.sel = sel;
			<ValidPlantTypesForGrower>c__Iterator11C.<$>sel = sel;
			GenPlant.<ValidPlantTypesForGrower>c__Iterator11C expr_15 = <ValidPlantTypesForGrower>c__Iterator11C;
			expr_15.$PC = -2;
			return expr_15;
		}
