...
namespace RimWorld
{
	public class Dialog_Negotiation : Dialog_NodeTree
	{
		...
		public Dialog_Negotiation(Pawn negotiator, ICommunicable commTarget, DiaNode startNode) : base(startNode)
		{
		...
		public override void DoWindowContents(Rect inRect)
		{
			...
			GUI.EndGroup();
			Rect drawRect = new Rect(0f, 100f, inRect.width, inRect.height - 100f);
			base.DrawNode(drawRect);
		}
	}
}
