...
namespace Verse
{
	...
	public class TabRecord
	{
		...
		public void Draw(Rect rect)
		{
			...
			drawRect3.width -= 60f;
			Rect texRect2 = new Rect(30f, 0f, 4f, (float)TabRecord.TabAtlas.height).ToUVRect(new Vector2((float)TabRecord.TabAtlas.width, (float)TabRecord.TabAtlas.height));
			Widgets.DrawTexturePart(drawRect, new Rect(0f, 0f, 0.46875f, 1f), TabRecord.TabAtlas);
			Widgets.DrawTexturePart(drawRect3, texRect2, TabRecord.TabAtlas);
			Widgets.DrawTexturePart(drawRect2, texRect, TabRecord.TabAtlas);
			Rect rect2 = rect;
			...
			if (!this.selected)
			{
				...
				Widgets.DrawTexturePart(drawRect4, texRect3, TabRecord.TabAtlas);
			}
		}
	}
}
