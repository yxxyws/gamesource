...
namespace Verse
{
	public class WeatherDef : Def
	{
		...
		{
			WeatherDef.<ConfigErrors>c__Iterator153 <ConfigErrors>c__Iterator = new WeatherDef.<ConfigErrors>c__Iterator153();
			<ConfigErrors>c__Iterator.<>f__this = this;
			WeatherDef.<ConfigErrors>c__Iterator153 expr_0E = <ConfigErrors>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
