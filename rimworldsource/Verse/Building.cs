...
namespace Verse
{
	public class Building : ThingWithComps
	{
		...
		public override void SpawnSetup()
		{
			...
			if (base.Faction == Faction.OfColony && this.def.building != null && this.def.building.spawnedConceptLearnOpportunity != null)
			{
				ConceptDecider.TeachOpportunity(this.def.building.spawnedConceptLearnOpportunity, OpportunityType.GoodToKnow);
			}
		...
		public override void DeSpawn()
		{
			...
			{
				RoofCollapser.Notify_RoofHolderRemoved(this);
			}
			...
			if (this.def.leaveTerrain != null && Game.Mode == GameMode.MapPlaying)
			{
		...
		{
			Building.<GetGizmos>c__IteratorCB <GetGizmos>c__IteratorCB = new Building.<GetGizmos>c__IteratorCB();
			<GetGizmos>c__IteratorCB.<>f__this = this;
			Building.<GetGizmos>c__IteratorCB expr_0E = <GetGizmos>c__IteratorCB;
			expr_0E.$PC = -2;
			return expr_0E;
		}
