...
namespace RimWorld
{
	public class Pawn_NativeVerbs : IExposable
	{
		...
		public bool TryStartIgnite(Thing target)
		{
			...
			return !this.pawn.stances.FullBodyBusy && this.IgniteVerb.TryStartCastOn(target, false);
		}
		public bool TryBeatFire(Fire targetFire)
		{
			...
			return !this.pawn.stances.FullBodyBusy && this.BeatFireVerb.TryStartCastOn(targetFire, false);
		}
