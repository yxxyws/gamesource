...
namespace Verse
{
	public sealed class Region
	{
		...
		public IEnumerable<IntVec3> Cells
		{
			get
			{
				Region.<>c__Iterator166 <>c__Iterator = new Region.<>c__Iterator166();
				<>c__Iterator.<>f__this = this;
				Region.<>c__Iterator166 expr_0E = <>c__Iterator;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		public IEnumerable<Region> Neighbors
		{
			get
			{
				Region.<>c__Iterator167 <>c__Iterator = new Region.<>c__Iterator167();
				<>c__Iterator.<>f__this = this;
				Region.<>c__Iterator167 expr_0E = <>c__Iterator;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		public IEnumerable<Region> NonPortalNeighbors
		{
			get
			{
				Region.<>c__Iterator168 <>c__Iterator = new Region.<>c__Iterator168();
				<>c__Iterator.<>f__this = this;
				Region.<>c__Iterator168 expr_0E = <>c__Iterator;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
			...
			if (DebugViewSettings.drawRegionLinks)
			{
				foreach (RegionLink current2 in this.links)
				{
					if (num == 1)
					{
						...
						{
							DebugRender.RenderCell(current3, DebugSolidColorMats.MaterialOf(Color.magenta));
						}
					}
				}
			}
