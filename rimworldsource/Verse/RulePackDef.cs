...
namespace Verse
{
	public class RulePackDef : Def
	{
		...
		{
			RulePackDef.<ConfigErrors>c__Iterator144 <ConfigErrors>c__Iterator = new RulePackDef.<ConfigErrors>c__Iterator144();
			<ConfigErrors>c__Iterator.<>f__this = this;
			RulePackDef.<ConfigErrors>c__Iterator144 expr_0E = <ConfigErrors>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
