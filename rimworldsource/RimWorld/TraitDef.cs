...
namespace RimWorld
{
	public class TraitDef : Def
	{
		...
		{
			TraitDef.<ConfigErrors>c__Iterator7A <ConfigErrors>c__Iterator7A = new TraitDef.<ConfigErrors>c__Iterator7A();
			<ConfigErrors>c__Iterator7A.<>f__this = this;
			TraitDef.<ConfigErrors>c__Iterator7A expr_0E = <ConfigErrors>c__Iterator7A;
			expr_0E.$PC = -2;
			return expr_0E;
		}
