...
namespace RimWorld
{
	public class Designator_Hunt : Designator
	{
		...
		{
			Designator_Hunt.<HuntablesInCell>c__Iterator10C <HuntablesInCell>c__Iterator10C = new Designator_Hunt.<HuntablesInCell>c__Iterator10C();
			<HuntablesInCell>c__Iterator10C.c = c;
			<HuntablesInCell>c__Iterator10C.<$>c = c;
			<HuntablesInCell>c__Iterator10C.<>f__this = this;
			Designator_Hunt.<HuntablesInCell>c__Iterator10C expr_1C = <HuntablesInCell>c__Iterator10C;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
