...
namespace RimWorld.Planet
{
	public sealed class World : IExposable
	{
		...
		public IEnumerable<IntVec2> AllSquares
		{
			get
			{
				World.<>c__IteratorA8 <>c__IteratorA = new World.<>c__IteratorA8();
				World.<>c__IteratorA8 expr_07 = <>c__IteratorA;
				expr_07.$PC = -2;
				return expr_07;
			}
		}
		public void ExposeData()
		{
			...
			{
				WorldGenerator_Grid.GenerateGridIntoCurrentWorld(this.info.seedString);
			}
			Scribe_Collections.LookList<Site>(ref this.sites, "sites", LookMode.Deep, new object[0]);
