...
namespace Verse
{
	...
	public static class TexUI
	{
		...
		public static readonly Texture2D ChoiceBGTexture;
		public static readonly Texture2D ChoiceBGTextureDisabled;
		public static readonly Texture2D UnknownThing;
		static TexUI()
		{
			...
			TexUI.ChoiceBGTexture = ContentFinder<Texture2D>.Get("UI/Widgets/FloatMenu/ChoiceBG", true);
			TexUI.ChoiceBGTextureDisabled = ContentFinder<Texture2D>.Get("UI/Widgets/FloatMenu/ChoiceBGDisabled", true);
			TexUI.UnknownThing = ContentFinder<Texture2D>.Get("UI/Widgets/UnknownThing", true);
		}
	}
}
