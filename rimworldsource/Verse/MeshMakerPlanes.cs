...
namespace Verse
{
	...
	{
		private const float BackLiftAmount = 0.035f;
		private const float TwistAmount = 0.0200000014f;
		...
		public static Mesh NewPlaneMesh(Vector2 size, bool flipped, bool backLift, bool twist)
		{
			...
			if (twist)
			{
				array[0].y = 0.0200000014f;
				array[1].y = 0.0100000007f;
				array[2].y = 0f;
				array[3].y = 0.0100000007f;
			}
			if (!flipped)
			{
