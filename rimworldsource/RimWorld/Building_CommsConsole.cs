...
namespace RimWorld
{
	public class Building_CommsConsole : Building
	{
		...
		public override void SpawnSetup()
		{
			...
			ConceptDecider.TeachOpportunity(ConceptDefOf.BuildOrbitalTradeBeacon, OpportunityType.GoodToKnow);
			ConceptDecider.TeachOpportunity(ConceptDefOf.OpeningComms, OpportunityType.GoodToKnow);
		}
		private void UseAct(Pawn myPawn, ICommunicable commTarget)
		{
			...
			ConceptDatabase.KnowledgeDemonstrated(ConceptDefOf.OpeningComms, KnowledgeAmount.Total);
		}
		public override IEnumerable<FloatMenuOption> GetFloatMenuOptions(Pawn myPawn)
		{
			if (!myPawn.CanReserve(this, 1))
			{
				FloatMenuOption item = new FloatMenuOption("CannotUseReserved".Translate(), null, MenuOptionPriority.Medium, null, null);
			...
			{
				FloatMenuOption item2 = new FloatMenuOption("CannotUseNoPath".Translate(), null, MenuOptionPriority.Medium, null, null);
				return new List<FloatMenuOption>
				{
					item2
				};
			...
			{
				FloatMenuOption item3 = new FloatMenuOption("CannotUseSolarFlare".Translate(), null, MenuOptionPriority.Medium, null, null);
				return new List<FloatMenuOption>
				{
					item3
				};
			...
			{
				FloatMenuOption item4 = new FloatMenuOption("CannotUseNoPower".Translate(), null, MenuOptionPriority.Medium, null, null);
				return new List<FloatMenuOption>
				{
					item4
				};
			...
			if (!this.CanUseCommsNow)
			{
				...
				FloatMenuOption item6 = new FloatMenuOption("Cannot use now", null, MenuOptionPriority.Medium, null, null);
				return new List<FloatMenuOption>
				{
					item6
				};
			...
			foreach (ICommunicable commTarget in enumerable)
			{
				...
				if (faction == null || faction.def != FactionDefOf.Colony)
				{
					...
					}), action, MenuOptionPriority.Medium, null, null));
				}
			}
			return list;
		}
