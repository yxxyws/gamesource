...
namespace Verse
{
	public static class GenRadial
	{
		...
		{
			GenRadial.<RadialPatternInRadius>c__Iterator1A4 <RadialPatternInRadius>c__Iterator1A = new GenRadial.<RadialPatternInRadius>c__Iterator1A4();
			<RadialPatternInRadius>c__Iterator1A.radius = radius;
			<RadialPatternInRadius>c__Iterator1A.<$>radius = radius;
			GenRadial.<RadialPatternInRadius>c__Iterator1A4 expr_15 = <RadialPatternInRadius>c__Iterator1A;
			expr_15.$PC = -2;
			return expr_15;
		}
		[DebuggerHidden]
		...
		{
			GenRadial.<RadialCellsAround>c__Iterator1A5 <RadialCellsAround>c__Iterator1A = new GenRadial.<RadialCellsAround>c__Iterator1A5();
			<RadialCellsAround>c__Iterator1A.radius = radius;
			<RadialCellsAround>c__Iterator1A.useCenter = useCenter;
			<RadialCellsAround>c__Iterator1A.center = center;
			<RadialCellsAround>c__Iterator1A.<$>radius = radius;
			<RadialCellsAround>c__Iterator1A.<$>useCenter = useCenter;
			<RadialCellsAround>c__Iterator1A.<$>center = center;
			GenRadial.<RadialCellsAround>c__Iterator1A5 expr_31 = <RadialCellsAround>c__Iterator1A;
			expr_31.$PC = -2;
			return expr_31;
		}
		[DebuggerHidden]
		...
		{
			GenRadial.<RadialDistinctThingsAround>c__Iterator1A6 <RadialDistinctThingsAround>c__Iterator1A = new GenRadial.<RadialDistinctThingsAround>c__Iterator1A6();
			<RadialDistinctThingsAround>c__Iterator1A.radius = radius;
			<RadialDistinctThingsAround>c__Iterator1A.useCenter = useCenter;
			<RadialDistinctThingsAround>c__Iterator1A.center = center;
			<RadialDistinctThingsAround>c__Iterator1A.<$>radius = radius;
			<RadialDistinctThingsAround>c__Iterator1A.<$>useCenter = useCenter;
			<RadialDistinctThingsAround>c__Iterator1A.<$>center = center;
			GenRadial.<RadialDistinctThingsAround>c__Iterator1A6 expr_31 = <RadialDistinctThingsAround>c__Iterator1A;
			expr_31.$PC = -2;
			return expr_31;
		}
	}
