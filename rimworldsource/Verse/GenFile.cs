...
namespace Verse
{
	public static class GenFile
	{
		...
		{
			GenFile.<LinesFromFile>c__Iterator1A3 <LinesFromFile>c__Iterator1A = new GenFile.<LinesFromFile>c__Iterator1A3();
			<LinesFromFile>c__Iterator1A.filePath = filePath;
			<LinesFromFile>c__Iterator1A.<$>filePath = filePath;
			GenFile.<LinesFromFile>c__Iterator1A3 expr_15 = <LinesFromFile>c__Iterator1A;
			expr_15.$PC = -2;
			return expr_15;
		}
