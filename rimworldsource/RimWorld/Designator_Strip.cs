...
namespace RimWorld
{
	public class Designator_Strip : Designator
	{
		...
		{
			Designator_Strip.<StrippablesInCell>c__Iterator110 <StrippablesInCell>c__Iterator = new Designator_Strip.<StrippablesInCell>c__Iterator110();
			<StrippablesInCell>c__Iterator.c = c;
			<StrippablesInCell>c__Iterator.<$>c = c;
			<StrippablesInCell>c__Iterator.<>f__this = this;
			Designator_Strip.<StrippablesInCell>c__Iterator110 expr_1C = <StrippablesInCell>c__Iterator;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
