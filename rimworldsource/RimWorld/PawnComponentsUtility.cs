...
namespace RimWorld
{
	public class PawnComponentsUtility
	{
		...
		public static void AddComponentsForSpawn(Pawn pawn)
		{
			...
			if (pawn.RaceProps.Humanlike && pawn.interactions == null)
			{
		...
		{
			bool flag = pawn.Faction != null && pawn.Faction.def == FactionDefOf.Colony;
			bool flag2 = pawn.HostFaction != null && pawn.HostFaction.def == FactionDefOf.Colony;
