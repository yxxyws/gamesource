...
namespace Verse.AI
{
	public static class ToilEffects
	{
		...
		public static Toil WithProgressBar(this Toil toil, TargetIndex ind, Func<float> progressGetter, bool interpolateBetweenActorAndTarget = false, float offsetZ = -0.5f)
		{
			...
			toil.AddPreTickAction(delegate
			{
				if (toil.actor.Faction != Faction.OfColony)
				{
					return;
				}
				if (effecter == null)
		...
		public static Toil WithSustainer(this Toil toil, SoundDef soundDef)
		{
			return toil.WithSustainer(() => soundDef);
		}
		public static Toil WithSustainer(this Toil toil, Func<SoundDef> soundDefGetter)
		{
