...
namespace Verse
{
	public class Pawn_EquipmentTracker : IExposable
	{
		...
		public IEnumerable<ThingWithComps> AllEquipment
		{
			get
			{
				Pawn_EquipmentTracker.<>c__Iterator184 <>c__Iterator = new Pawn_EquipmentTracker.<>c__Iterator184();
				<>c__Iterator.<>f__this = this;
				Pawn_EquipmentTracker.<>c__Iterator184 expr_0E = <>c__Iterator;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		public IEnumerable<Verb> AllEquipmentVerbs
		{
			get
			{
				Pawn_EquipmentTracker.<>c__Iterator185 <>c__Iterator = new Pawn_EquipmentTracker.<>c__Iterator185();
				<>c__Iterator.<>f__this = this;
				Pawn_EquipmentTracker.<>c__Iterator185 expr_0E = <>c__Iterator;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		{
			Pawn_EquipmentTracker.<GetGizmos>c__Iterator186 <GetGizmos>c__Iterator = new Pawn_EquipmentTracker.<GetGizmos>c__Iterator186();
			<GetGizmos>c__Iterator.<>f__this = this;
			Pawn_EquipmentTracker.<GetGizmos>c__Iterator186 expr_0E = <GetGizmos>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
