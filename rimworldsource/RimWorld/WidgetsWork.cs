...
namespace RimWorld
{
	...
	public static class WidgetsWork
	{
		...
		public static void DrawWorkBoxFor(Vector2 topLeft, Pawn p, WorkTypeDef wType, bool incapableBecauseOfCapacities)
		{
		...
		public static TipSignal TipForPawnWorker(Pawn p, WorkTypeDef wDef, bool incapableBecauseOfCapacities)
		{
