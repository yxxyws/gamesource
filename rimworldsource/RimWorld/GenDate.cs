...
namespace RimWorld
{
	public static class GenDate
	{
		...
		public static string TickstoDaysString(this int numTicks)
		{
			return numTicks.TicksToDays().ToString("F1") + " " + "DaysLower".Translate();
		}
		public static string TicksToPeriodExtendedString(this int numTicks)
		{
			if (numTicks > 36000000)
			{
				return "OverADecade".Translate();
			}
			return numTicks.TicksToPeriodString(false);
		}
		public static string TicksToPeriodString(this int numTicks, bool allowHours = true)
		{
			if (numTicks < 0)
			{
				return "0";
