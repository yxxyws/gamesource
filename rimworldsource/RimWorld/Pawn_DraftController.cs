...
namespace RimWorld
{
	public class Pawn_DraftController : IExposable
	{
		...
		{
			Pawn_DraftController.<GetGizmos>c__Iterator9E <GetGizmos>c__Iterator9E = new Pawn_DraftController.<GetGizmos>c__Iterator9E();
			<GetGizmos>c__Iterator9E.<>f__this = this;
			Pawn_DraftController.<GetGizmos>c__Iterator9E expr_0E = <GetGizmos>c__Iterator9E;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
