...
namespace Verse
{
	public sealed class ThingContainer : IEnumerable, IEnumerable<Thing>, IExposable
	{
		...
		public bool TryDrop(Thing thing, IntVec3 dropLoc, ThingPlaceMode mode, int count, out Thing resultingThing)
		{
		...
		public bool TryDrop(Thing thing, ThingPlaceMode mode, out Thing lastResultingThing)
		{
			...
			return this.TryDrop(thing, thing2.Position, mode, out lastResultingThing);
		}
		public bool TryDrop(Thing thing, IntVec3 dropLoc, ThingPlaceMode mode, out Thing lastResultingThing)
		{
		...
		public bool TryDropAll(IntVec3 dropLoc, ThingPlaceMode mode)
		{
			...
			{
				Thing thing;
				if (!this.TryDrop(this.innerList[i], dropLoc, mode, out thing))
				{
					return false;
				}
			}
