	...
	public static class BuildingsDamageSectionLayerUtility
	{
		...
		public static Rect GetDamageRect(Building b)
		{
			...
			if (damageGraphicData != null)
			{
				...
				{
					if (b.Rotation == Rot4.East && damageGraphicData.rectE != default(Rect))
					{
					...
					{
						if (b.Rotation == Rot4.South && damageGraphicData.rectS != default(Rect))
						{
						...
						{
							if (b.Rotation == Rot4.West && damageGraphicData.rectW != default(Rect))
							{
							...
							{
								if (damageGraphicData.rect != default(Rect))
								{
