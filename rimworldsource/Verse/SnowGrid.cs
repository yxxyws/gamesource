...
namespace Verse
{
	public sealed class SnowGrid : IExposable
	{
		...
		public void AddDepth(IntVec3 c, float depthToAdd)
		{
			...
			this.totalDepth += num4;
			if (Mathf.Abs(num4) > 0.0001f)
			{
				this.depthGrid[num] = num3;
				this.CheckVisualChange(c, num2, num3);
			}
		}
		public void SetDepth(IntVec3 c, float newDepth)
		{
			...
			this.totalDepth += num3;
			this.CheckVisualChange(c, num2, newDepth);
		}
		private void CheckVisualChange(IntVec3 c, float oldDepth, float newDepth)
		{
